...
const novaPoshtaQuery = {
  getNovaPoshtaCities: async (parent, args) =>
    await novaPoshtaService.getNovaPoshtaCities(args.city),

  getNovaPoshtaStreets: async (parent, args) =>
    await novaPoshtaService.getNovaPoshtaStreets(args.cityRef, args.street),

  getNovaPoshtaWarehouses: async (parent, args) =>
    await novaPoshtaService.getNovaPoshtaWarehouses(args.city),

  getNovaPoshtaPrices: async (parent, args) =>
    await novaPoshtaService.getNovaPoshtaPrices(args.data),
